...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(58, 136, 145));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/man (1).png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Snap ITC", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("KING OF THE GOD");
        ...
        jPanel3.setBackground(new java.awt.Color(14, 94, 111));
        jPanel3.setPreferredSize(new java.awt.Dimension(375, 368));

        txt_username.setBackground(new java.awt.Color(14, 94, 111));
        ...
        txt_pass.setBackground(new java.awt.Color(14, 94, 111));
        ...
        jButton1.setBackground(new java.awt.Color(14, 94, 111));
        ...
        btn_login.setBackground(new java.awt.Color(14, 94, 111));
        ...
        btn_cancel.setBackground(new java.awt.Color(14, 94, 111));
        btn_cancel.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_cancel.setText("CANCEL");

        jLabel2.setText("NO ACC? / CREATE ONE");
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        else if (txt_username.getText().contains("smith") && txt_pass.getText().contains("1234")){
        ...
        //// with data connection data mysql
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/login_injava","root","");
            ...
            JOptionPane.showMessageDialog(null, "username or password didn't matched");
            txt_username.setText("");
            txt_pass.setText("");
            }
            con.close();
